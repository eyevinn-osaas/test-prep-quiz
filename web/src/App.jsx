...
const shell = (children) => (
  <div style={{fontFamily:"Poppins, system-ui", color:"#e8ebff", background:"#0f1320", height:"100%", display:"flex", flexDirection:"column", overflow:"hidden"}}>
    <header style={{display:"flex",justifyContent:"space-between",padding:"clamp(8px, 1vh, 12px) 16px",background:"#12172b",borderBottom:"1px solid #242b4a",flexShrink:0}}>
    ...
    <main className="app-main" style={{padding:"clamp(8px, 1.5vh, 16px) clamp(8px, 2vw, 16px)",width:"100%",flex:1,display:"flex",flexDirection:"column",overflow:"auto",minHeight:0}}>
      {children}
    </main>
  </div>
);
