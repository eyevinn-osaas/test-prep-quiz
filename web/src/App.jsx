...
const shell = (children) => (
  <div style={{fontFamily:"Inter, system-ui", color:"#e8ebff", background:"#0f1320", minHeight:"100vh"}}>
    <header style={{display:"flex",justifyContent:"space-between",padding:"12px 16px",background:"#12172b",borderBottom:"1px solid #242b4a"}}>
      <strong>⚡ Test Prep – Multiplayer</strong>
      <nav style={{display:"flex",gap:12}}>
        <Link to="/gm" style={{color:"#6ee7b7"}}>Game Master</Link>
        <Link to="/play" style={{color:"#9aa6ff"}}>Join</Link>
      </nav>
    </header>
